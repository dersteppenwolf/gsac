 ...
 */
public class RingDatabaseManager extends GsacDatabaseManager {
    ...
    */
     ...
     */
    public RingDatabaseManager(RingRepository repository)
            throws Exception {
        super(repository);
    }
    ...
    public static void main(String[] args) throws Exception {
        RingDatabaseManager dbm = new RingDatabaseManager(null);
        dbm.init();
