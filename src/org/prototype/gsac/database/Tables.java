/** Tables.java makes classes which represent the tables and fields in your database.

    It is created with GSAC code which reads your database and creates an all-new Tables.java file in your local GSAC code area.
    Generated by running: java org.unavco.projects.gsac.repository.UnavcoGsacDatabaseManager
    See the GSAC installation README (part 2) file in your local GSAC code area.
**/
...
/* old import org.ramadda.sql.SqlUtil; */
...
public abstract class Tables {
    ...
    public static class AGENCY extends Tables {
        ...
        public static final String COL_RESPONSIBLE_PERSON_NAME =  NAME + ".responsible_person_name";
        public static final String COL_RESPONSIBLE_PERSON_TELEPHONE =  NAME + ".responsible_person_telephone";
        public static final String COL_RESPONSIBLE_PERSON_EMAIL =  NAME + ".responsible_person_email";
        public static final String COL_OTHER_CONTACT =  NAME + ".other_contact";

        public static final String[] ARRAY = new String[] {
            COL_AGENCY_ID,COL_OPERATING_AGENCY_NAME,COL_OPERATING_AGENCY_ADDRESS,COL_OPERATING_AGENCY_EMAIL,COL_RESPONSIBLE_PERSON_NAME,COL_RESPONSIBLE_PERSON_TELEPHONE,COL_RESPONSIBLE_PERSON_EMAIL,COL_OTHER_CONTACT
        };
        public static final String COLUMNS = SqlUtil.comma(ARRAY);
        public static final String NODOT_COLUMNS = SqlUtil.commaNoDot(ARRAY);
    ...
    public static class DATAFILE extends Tables {
        ...
        public static final String COL_URL_PATH_DOMAIN =  NAME + ".URL_path_domain";
        ...
        public static final String[] ARRAY = new String[] {
            COL_DATAFILE_ID,COL_STATION_ID,COL_EQUIP_CONFIG_ID,COL_DATAFILE_NAME,COL_URL_COMPLETE,COL_DATA_TYPE_ID,COL_DATAFILE_FORMAT_ID,COL_DATA_REFERENCE_FRAME_ID,COL_DATAFILE_START_TIME,COL_DATAFILE_STOP_TIME,COL_DATAFILE_PUBLISHED_DATE,COL_URL_PROTOCOL,COL_URL_PATH_DOMAIN,COL_URL_PATH_DIRS,COL_SAMPLE_INTERVAL,COL_LATENCY_ESTIMATE,COL_YEAR,COL_DAY_OF_YEAR,COL_SIZE_BYTES,COL_MD5
        };
        public static final String COLUMNS = SqlUtil.comma(ARRAY);
        public static final String NODOT_COLUMNS = SqlUtil.commaNoDot(ARRAY);
    ...
    public static class STATION extends Tables {
        ...
        public static final String[] ARRAY = new String[] {
            COL_STATION_ID,COL_FOUR_CHAR_NAME,COL_STATION_NAME,COL_LATITUDE_NORTH,COL_LONGITUDE_EAST,COL_HEIGHT_ELLIPSOID,COL_X,COL_Y,COL_Z,COL_INSTALLED_DATE,COL_RETIRED_DATE,COL_AGENCY_ID,COL_ACCESS_ID,COL_STATION_STYLE_ID,COL_STATUS_ID,COL_MONUMENT_STYLE_ID,COL_NATION_ID,COL_PROVINCE_STATE_ID,COL_LOCALE_ID,COL_ELLIPSOID_ID,COL_NETWORKS,COL_IERS_DOMES,COL_STATION_PHOTO_URL,COL_TIME_SERIES_PLOT_IMAGE_URL,COL_EMBARGO_DURATION_HOURS,COL_EMBARGO_AFTER_DATE
        };
        public static final String COLUMNS = SqlUtil.comma(ARRAY);
        public static final String NODOT_COLUMNS = SqlUtil.commaNoDot(ARRAY);
