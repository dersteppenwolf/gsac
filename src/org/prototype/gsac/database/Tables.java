/** Tables.java makes classes which represent the tables and fields in your database.      
    ...
    Generated by running 'ant tables' which calls the GSAC code  GsacDatabaseManager:writeTables().    
    See the GSAC installation README (part 2) file in your local GSAC code area.
    If you get an error building your local GSAC with 'ant' it may be caused by your Java code calling a for a TABLES variable (db field) which does not exist here or in the db.
**/ 
