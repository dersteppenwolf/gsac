...
INSERT INTO `file_type` VALUES (1,'IGS site log file'),(2,'RINEX GLONASS navigation file'),(3,'RINEX met file'),(4,'RINEX navigation file'),(5,'RINEX observation file'),(6,'SINEX'),(7,'SOPAC XML log file'),(8,'Time series PBO csv format'),(9,'Time series PBO pos format');
...
CREATE TABLE `gnss_data_file` (
  ...
  `file_filename` varchar(120) DEFAULT NULL,
  PRIMARY KEY (`file_id`)
...
CREATE TABLE `project` (
  `project_id` int(5) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2013-10-17 11:53:04
