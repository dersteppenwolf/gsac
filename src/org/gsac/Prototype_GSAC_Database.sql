...
CREATE TABLE `antenna_session` (
  ...
  `antenna_removed_date` datetime NOT NULL,
...
INSERT INTO `file_type` VALUES (1,'RINEX observation file,  Z compression (o.Z)'),(2,'RINEX navigation file (n)'),(3,'RINEX met file (m)'),(4,'RINEX observation file; Hatanaka; Z compression (d.Z)'),(5,'RINEX navigation file; Z compression (n.Z)'),(6,'RINEX GLONASS navigation file; Z compression (g.Z)'),(7,'IGS site log file'),(8,'SINEX'),(9,'PBO Time Series, .pos format'),(10,'RINEX observation file (o); no compression'),(11,'PBO Time Series, .csv format');
...
CREATE TABLE `project` (
  ...
  `agency_id` int(4) unsigned NOT NULL,
...
INSERT INTO `province_region_state` VALUES (1,'');
...
CREATE TABLE `station` (
  ...
  `code_4char_ID` char(4) NOT NULL COMMENT 'The station 4 character identifier such as P123',
...
-- Dump completed on 2013-10-03 10:40:58
