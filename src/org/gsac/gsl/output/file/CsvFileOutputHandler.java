    ...
    public void processResource(GsacResponse response,
        ...
        try {
            ...
            if (firstTime) {
                ...
                // new 2 lines:
                pw.print("#fields=Id[type='string'],Type[type='string'],MD5[type='string'],FileSize,PublishDate[type='date'],URL[type='string'],dataStartTime[type='date' format='yyyy-MM-dd HH:mm:ss'],dataStopTime[type='date' format='yyyy-MM-dd HH:mm:ss'],sampleInterval\n");
