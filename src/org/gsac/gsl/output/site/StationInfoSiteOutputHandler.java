    ...
    public StationInfoSiteOutputHandler(GsacRepository gsacRepository,
        ...
        getRepository().addOutput(getResourceClass(),
                                  new GsacOutput(this, OUTPUT_SITE_STATIONINFO,
                                      "Site station.info", "/sites.stationinfo", true));
                                    //  "Site station.info" is apparently a label for Results choice box in site search form on web page.
