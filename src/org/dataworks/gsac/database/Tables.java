...
public abstract class Tables {
    ...
    public static class AGENCY extends Tables {
        ...
        public static final String[] ARRAY = new String[] {
            COL_AGENCY_ID,COL_AGENCY_NAME,COL_AGENCY_URL,COL_AGENCY_SHORT_NAME
        };
        public static final String COLUMNS = SqlUtil.comma(ARRAY);
        public static final String NODOT_COLUMNS = SqlUtil.commaNoDot(ARRAY);
    ...
    public static class DATAFILE extends Tables {
        ...
        public static final String COL_IGS_DATAFILE_NAME =  NAME + ".IGS_datafile_name";
        ...
        public static final String COL_DATA_ORIGINATOR_URL_DOMAIN =  NAME + ".data_originator_url_domain";

        public static final String[] ARRAY = new String[] {
            COL_DATAFILE_ID,COL_STATION_ID,COL_EQUIP_CONFIG_ID,COL_DATAFILE_NAME,COL_IGS_DATAFILE_NAME,COL_URL_PATH,COL_DATAFILE_START_TIME,COL_DATAFILE_STOP_TIME,COL_PUBLISHED_TIME,COL_SAMPLE_INTERVAL,COL_SIZE_BYTES,COL_MD5,COL_UNIQUE_INFO_ID,COL_ORIGINAL_DATAFILE_NAME,COL_DATAFILE_TYPE_ID,COL_YEAR,COL_DAY_OF_YEAR,COL_DATA_ORIGINATOR_URL_DOMAIN
        };
        public static final String COLUMNS = SqlUtil.comma(ARRAY);
        public static final String NODOT_COLUMNS = SqlUtil.commaNoDot(ARRAY);
