...
--
-- Host: localhost    Database: Dataworks
-- ------------------------------------------------------
...
--
-- Current Database: `Dataworks`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `Development_Dataworks` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `Development_Dataworks`;
...
INSERT INTO `agency` VALUES (2,'Institut Geographique National',''),(5,'University of Puerto Rico, Mayaguez',''),(6,'Panama Canal Authority',''),(7,'University of Arkansas',''),(8,'Suprema Corte De Justicia',''),(9,'National Geodetic Survey',''),(10,'University Center for Atmospherhic Research','UCAR'),(11,'National Aeronautics and Space Administration','NASA'),(12,'Cayman Islands Government',''),(13,'UNAVCO','UNAVCO'),(14,'Instituto Geografico Nacional, Guatemala',''),(15,'Purdue University',''),(16,'Instituto Nicaraguense de Estudios Territoriales',''),(17,'University of Texas at Arlington',''),(18,'University of Miami',''),(19,'Montserrat Volcano Observatory',''),(20,'Geomedicion, Instruments and Systems, Inc',''),(21,'GeoForschungsZentrum-Potsdam',''),(22,'Centro Nacional de Registros',''),(23,'Direccion General de Catastro y Geografia',''),(24,'Universidad Nacional Autonoma de Mexico',''),(25,'INGEOMINAS','');
...
INSERT INTO `country` VALUES (1,'Mexico'),(2,'U.S.');
...
) ENGINE=InnoDB AUTO_INCREMENT=5649 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `metpack` VALUES (1,'WXT520');
...
INSERT INTO `monument_style` VALUES (1,'shallow foundation pillar'),(2,'building roof'),(3,'deep-drilled braced');
...
INSERT INTO `network` VALUES (1,'TLALOCNet'),(2,'COCONet');
...
-- Dump completed on 2014-12-02 22:33:01
