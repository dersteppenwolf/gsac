...
CREATE TABLE `datafile_format` (
  ...
  `datafile_format_description` varchar(50) NOT NULL,
...
INSERT INTO `datafile_format` VALUES (1,'instrument raw binary file','',''),(2,'RINEX observation file','',''),(3,'RINEX GPS navigation file','',''),(4,'RINEX Galileo navigation file','',''),(5,'RINEX GLONASS navigation file','',''),(6,'RINEX meteorology file','','');
...
INSERT INTO `ellipsoid` VALUES (1,'WGS84','WGS84');
...
INSERT INTO `metpack` VALUES (1,'metpack missing');
...
INSERT INTO `monument_style` VALUES (1,'INOX METAL PILLAR'),(2,'METAL PILLAR'),(3,'PILLAR'),(4,'STEEL MAST'),(5,' ');
...
INSERT INTO `network` VALUES (1,'COCONet');
...
-- Dump completed on 2014-08-11 12:18:31
