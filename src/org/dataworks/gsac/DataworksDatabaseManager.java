 ...
 */
public class DataworksDatabaseManager extends GsacDatabaseManager {
    ...
    */
    ...
    public static final String DB_PROPERTIES =
        "/org/dataworks/gsac/resources/gsacdb.properties";
     ...
     */
    public DataworksDatabaseManager(DataworksRepository repository)
            throws Exception {
        super(repository);
    }
    ...
    public static void main(String[] args) throws Exception {
        DataworksDatabaseManager dbm = new DataworksDatabaseManager(null);
        dbm.init();
