...
INSERT INTO `agency` VALUES (1,'not specified',' ');
...
CREATE TABLE `datafile` (
  ...
  `datafile_format_id` int(3) unsigned NOT NULL,
...
INSERT INTO `datafile_format` VALUES (1,'instrument data file','','Any type or format of native, raw, or binary file '),(2,'RINEX observation file','','RINEX obs file of any type: o, d, .zip, d.zip, etc'),(3,'RINEX GPS navigation file','',''),(4,'RINEX Galileo navigation file','',''),(5,'RINEX GLONASS navigation file','',''),(6,'RINEX meteorology file','','');
...
INSERT INTO `monument_style` VALUES (1,'not specified');
...
INSERT INTO `radome` VALUES (1,'not specified','N');
